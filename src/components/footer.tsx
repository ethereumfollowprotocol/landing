...
export function Footer() {
  return (
    <footer className='flex space-x-3 fixed top-0 left-4 right-4 justify-end items-center h-16'>
      <Link
        href='https://github.com/ethereumfollowprotocol'
        target='_blank'
        rel='noopener noreferrer'
        className='rounded-full bg-transparent pr-1'
      >
        <svg
          className='w-8 h-8 text-gray-900 hover:text-gray-900'
          viewBox='0 0 15 15'
          fill='none'
      ...
      <Button
        ...
        size='1'
        variant='solid'
        className='text-black font-extrabold bg-transparent'
        asChild
      >
        <Link
      ...
      <Button
        ...
        size='1'
        variant='solid'
        className='text-black font-extrabold bg-transparent pl-0'
        asChild
      >
        <Link
