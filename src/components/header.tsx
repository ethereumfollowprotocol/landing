import { Avatar, Box, Link } from '@radix-ui/themes'
...
export function Header() {
  return (
    <header
      ...
      className='flex top-0 fixed mt-0 justify-between h-5'
    >
      <Avatar
        color='indigo'
        highContrast
      ...
      <div className='flex items-center mr-5'>
        <Link
          ...
          className='rounded-full bg-transparent mx-1'
        >
          <svg
        ...
        <Link
          ...
          target='_blank'
          rel='noopener noreferrer'
          className='text-black font-bold text-lg px-2 mx-1'
        >
          DOCS
        </Link>
        ...
        <Link
          ...
          target='_blank'
          rel='noopener noreferrer'
          className='text-black font-bold text-lg mx-1'
        >
          DEMO
        </Link>
      </div>
